          ...
          {!canChangeRoles && (
            <div className="bg-yellow-900/20 border border-yellow-700/30 rounded-lg p-4 mb-6">
              <p className="text-yellow-300 text-sm">
                <span className="font-medium">Manager Access:</span> You can
                view all users but cannot change user roles. Only administrators
              ...
              <tbody>
                {users.map((user) => (
                  <motion.tr
                    ...
                    >
                      <button className="bg-rose-500 p-2 rounded">
