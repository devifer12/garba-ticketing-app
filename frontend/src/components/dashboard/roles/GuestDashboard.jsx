        ...
        >
          ...
          <div className="bg-slate-700/50 backdrop-blur-xl rounded-2xl p-6 border border-slate-600/30">
            ...
            <p className="text-lg text-slate-300 mb-4">
              You are <span className="text-navratri-orange font-semibold">Guest</span>
            </p>
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              >
                ...
                <h3 className="text-white font-semibold mb-1">Book Tickets</h3>
                <p className="text-slate-400 text-sm">Purchase your Garba tickets</p>
              </motion.div>
              ...
              >
                <div className="text-2xl mb-2">🎵</div>
                <h3 className="text-white font-semibold mb-1">Event Details</h3>
                <p className="text-slate-400 text-sm">View event information</p>
              </motion.div>
            </div>
